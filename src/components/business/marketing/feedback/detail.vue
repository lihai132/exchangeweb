                    ...
                    <div class="information">
                        <div class="news-noe">
                            ...
                            <el-form ref="dataForm" :rules="rules" label-suffix=":" :model="data" label-width="130px">
                                <el-form-item label="投诉类型"  prop="fType"  >
                                    <el-select style="width:200px;" disabled="true" v-model="data.fType" >
                                        <el-option
                                ...
                                <el-form-item prop="fReplyContent" label="处理结果">
                                        <el-input type="textarea" :rows="5" disabled="true" style="width:400px;" v-model="data.fReplyContent"></el-input>
                                    </el-form-item>
                            </el-form>
...
export default {
    ...
    methods: {
        ...
        commitData(){
            ...
            var jsonData = request('/businessManagement/feedback/replyDo', this.data);
