        ...
        <div class="container">
                <el-form label-suffix=":"  ref="query" :model="query" label-width="90px">
                    <div style="width:800px;">
                            <el-form-item prop="fEvaluateType"  style="width:230px;display:inline-block;margin-right:20px;" label="评价类型">
                            <el-select v-model="query.fEvaluateType" >
								<el-option label="全部" value="-1"> </el-option>
                                    <el-option
                                    v-for="item in this.evaluateType"
                                    :key="item.key"
                                    :label="item.value"
                                    :value="item.key">
                                    </el-option>
                            ...
                            <el-form-item prop="fName" style="width:230px;display:inline-block;margin-right:20px;" label="评价人">
        
                            <el-input v-model="query.fName"></el-input>
                            </el-form-item>
                            <el-form-item prop="fNameEval"  style="width:230px;display:inline-block;margin-right:20px;" label="被评价人">
                            <el-input v-model="query.fNameEval"></el-input>
                            </el-form-item>
                    </div>
                    <div style="width:800px;">
                ...
                <el-table :data="tableData"  border class="table" ref="multipleTable" header-cell-class-name="table-header" highlight-current-row @row-click="clickTableRow" @current-change="selectChage" @row-contextmenu="rightClick" :summary-method="getSummaries" show-summary>
                    ...
                    <el-table-column :show-overflow-tooltip="true"  prop="fWaybillCode" label="运单编号" width="160" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fEvaluateType" :formatter="formatfEvaluateType" label="评价类型" width="160" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fName" label="评价人" width="160" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fNameEval" label="被评价人" width="160" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fPoints" label="评分" width="100" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fContent" label="评价内容" width="200" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fCreateTime" label="评价时间" width="160" align="center"> </el-table-column>
                </el-table>
...
export default {
    ...
    methods: {
        ...
        // 获取表格数据
        async init() {
            this.evaluateType = (await request('/enum/evaluateType/api', '')).data;
			this.getData();
        },
        // 获取表格数据
        async getData() {
			...
			this.querying = true;
            var jsonData = (await request('/businessManagement/evaluate/list', this.query)).data;
            this.querying = false;
      ...
      formatfEvaluateType(row){
        return tool.getEnumValue(this.evaluateType,row.fEvaluateType);
      }
