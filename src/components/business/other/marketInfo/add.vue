                    ...
                    <div class="information">
                        <div class="news-noe">
                            <div class="formatLine">
                                ...
                                <div class="formatTittle">- 新增行情</div>
                            ...
                            <div style="width:800px;">
                                ...
                                <el-form-item prop="fFreight" label="价格" >
                                    <el-input v-model="data.fFreight" style="width:215px;"></el-input>元
                                </el-form-item>
                                <el-form-item prop="fWeight" label="重量" >
                                    <el-input v-model="data.fWeight" style="width:215px;"></el-input>吨
                                </el-form-item>
                                <el-form-item prop="fVolume" label="体积" > 
                                    <el-input v-model="data.fVolume" style="width:215px;"></el-input>立方米
                                </el-form-item>
                                <el-form-item prop="fDistance" label="距离" >
                                    <el-input v-model="data.fDistance" style="width:215px;" :disabled="true"></el-input>公里
                                </el-form-item>
...
export default {
    ...
    data() {
        return {
            ...
            fFreight: [
                ...
                { max: 12, message: '长度在 12个字符内', trigger: 'blur' }
            ],
            fWeight: [
    ...
    methods: {
        ...
        async commitData(){
            var jsonData = (await request('/businessManagement/marketQuotation/add', this.data));
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
              let obj = this;
              //this.commitData();
             request('/businessManagement/marketQuotation/add', this.data).then(response => { 
