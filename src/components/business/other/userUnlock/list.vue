        ...
        <div class="container">
                <el-form label-suffix=":"  ref="query" :model="query" label-width="90px">
                    <div style="width:800px;">
                            <el-form-item prop="fMemberCode" style="width:230px;display:inline-block;margin-right:20px;" label="运营商编号">
                                <el-input v-model="query.fMemberCode"></el-input>
                            </el-form-item>
                            <el-form-item prop="fName" style="width:230px;display:inline-block;margin-right:20px;" label="用户简称">
                                <el-input v-model="query.fName"></el-input>
                            </el-form-item>
                            <el-form-item prop="fMobile"  style="width:230px;display:inline-block;margin-right:20px;" label="用户账号">
                                <el-input v-model="query.fMobile"></el-input>
                            </el-form-item>
                    </div>
                    <div style="width:800px;">
                            <el-form-item prop="fTraderType"  style="width:230px;display:inline-block;margin-right:20px;" label="用户类型">
                            <el-select v-model="query.fTraderType" >
                ...
                <el-table :data="tableData"  border class="table" ref="multipleTable" header-cell-class-name="table-header" highlight-current-row @row-click="clickTableRow" @current-change="selectChage" @row-contextmenu="rightClick" :summary-method="getSummaries" show-summary>
					...
					<el-table-column :show-overflow-tooltip="true"  prop="fMemberCodeEx" label="运营商编号" width="160" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fMobile" label="用户账号" width="160" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fName" label="用户简称" width="160" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true" :formatter="formatfTraderType"  prop="fTraderType" label="用户类型" width="160" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true" :formatter="formatfLockStatus"  prop="fLockStatus" label="用户状态" width="160" align="center"> </el-table-column>
                </el-table>
...
export default {
    ...
    methods: {
        ...
        async init() {
            ...
            this.traderLockStatus = (await request('/enum/traderLockStatus/api', '')).data;
			this.getData();
        },
        // 获取表格数据
        async getData() {
			...
			this.querying = true;
            var jsonData = (await request('/businessManagement/userUnlock/list', this.query)).data;
            this.querying = false;
        ...
        // 
        async unlock() {
            var jsonData = (await request('/businessManagement/userUnlock/unlock',{"fTraderId":this.rowData.fTraderId.toString()}));
        ...
        buttonClick(item) {
            if (item == '新增') {
                    ...
                    if (str == '{}') {
                        ...
                        if (item == '解锁') {
                            this.$confirm('确定解锁用户'+this.rowData.fName+'?', '提示', {
      ...
      formatfLockStatus(row){
        return tool.getEnumValue(this.traderLockStatus,row.fLockStatus);
      }
