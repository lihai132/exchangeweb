        ...
        <div class="container">
            <div class="head">
                <div class="head-one">
                    <div class="input1">
                        ...
                        <el-input v-model="query.name" placeholder="请输入内容" style="width:170px"></el-input>
                    </div>
                    <div class="input1">
                        <div class="title">运营商编号/简称：</div>
                        <el-input v-model="query.code" placeholder="请输入内容" style="width:170px"></el-input>
                    </div>
			...
			<el-table-column :show-overflow-tooltip="true" label="序号" type="index" width="80" :index='indexMethod' align="center"></el-table-column>
                ...
                <el-table-column :show-overflow-tooltip="true" 
                    ...
                    align="center"
                ></el-table-column>
                <el-table-column :show-overflow-tooltip="true" prop="fCodeEx" label="运营商编号" width="120" align="center"></el-table-column>
                <el-table-column :show-overflow-tooltip="true" prop="fNameEx" label="运营商简称" width="160" align="center"></el-table-column>
                <el-table-column :show-overflow-tooltip="true" 
                    prop="fType"
                    ...
                    align="center"
                ></el-table-column>
                <el-table-column :show-overflow-tooltip="true" prop="fChargeOpenMin" label="客服服务费下限" width="120" align="center"></el-table-column>
                <el-table-column :show-overflow-tooltip="true" prop="fChargeOpenMax" label="客服服务费上限" width="120" align="center"></el-table-column>
                <el-table-column :show-overflow-tooltip="true" 
                    prop="fChargeOpenMarket"
                    label="市场留存客服服务费"
                    :formatter="formatfChargeOpenMarket"
                    width="150"
                    align="center"
                ></el-table-column>
                <el-table-column :show-overflow-tooltip="true" prop="fChargeCloseMin" label="调度服务费下限" width="120" align="center"></el-table-column>
                <el-table-column :show-overflow-tooltip="true" prop="fChargeCloseMax" label="调度服务费上限" width="120" align="center"></el-table-column>
                <el-table-column :show-overflow-tooltip="true" 
                    prop="fChargeCloseMarket"
                    label="市场留存调度服务费"
                    :formatter="formatfChargeCloseMarket"
                    width="150"
                    align="center"
                ></el-table-column>
                <el-table-column :show-overflow-tooltip="true" prop="fCreator" label="创建人" width="150" align="center"></el-table-column>
...
import add from '../serverChargeCustomize/add.vue';
import update from '../serverChargeCustomize/update.vue';
...
export default {
    ...
    methods: {
        ...
        async getData() {
			...
			this.querying = true;
            var jsonData = await request('/parameter/servercharge/customsize/list', this.query);
			this.querying = false;
                ...
                if (item == '新增') {
                    ...
                    if (str == '{}') {
                        ...
                        if (item == '修改') {
                            ...
                            let popup1 = {
                                title: item + '运营商服务费方案',
                                fSchemaId: this.rowData.fSchemaId
                            };
                            this.$store.commit('setPopup1', popup1);
