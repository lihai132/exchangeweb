    ...
    <div class="BaseTable" @click="onMouseDown">
        <div class="container">
            <div class="head">
                <div class="head-one">
					...
					<div class="input1">
					    ...
					    <el-input v-model="query.traderName" maxlength="32" style="width:170px"></el-input>
					</div>
					<div class="input1">
					    <div class="title">司机手机：</div>
            ...
            >
				...
				<el-table-column :show-overflow-tooltip="true" prop="fName" label="司机名称" width="220" align="center"></el-table-column>
                <el-table-column :show-overflow-tooltip="true" prop="fMobile" label="司机手机" width="140" align="center"></el-table-column>
				<el-table-column :show-overflow-tooltip="true" prop="fCarNumber" label="车牌号" width="220" align="center"></el-table-column>
				<el-table-column :show-overflow-tooltip="true" prop="customerDispatcherMobile" label="调度员账号" width="140" align="center"></el-table-column>
				<el-table-column :show-overflow-tooltip="true" prop="customerDispatcherName" label="调度员简称" width="220" align="center"></el-table-column>
            </el-table>
            <div class="page">
                <el-pagination
...
import popup from './popup/driverBindDispatcherPop.vue';
...
export default {
    ...
    methods: {
       ...
       async getData() {
		   ...
		   this.querying = true;
		   let list = await request('/account/customerDispatch/driverBindList', this.query);
		   this.querying = false;
		   this.selectedRow='';
