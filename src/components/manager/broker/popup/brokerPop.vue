                        ...
                        <div class="news-noe">
                            ...
                            <div class="nav">
                                ...
                                <div class="line">
									...
									<!-- <div class="line-center">
									    <div class="name required">经纪人分组：</div>
									    <el-select
											...
											:disabled="bean.showType=='detail'"
									    >
									        <el-option key="1" label="客户经纪人分组" value="1"></el-option>
									        <el-option key="2" label="车辆经纪人分组" value="2"></el-option>
									    </el-select>
									</div> -->
							    </div>
							</div>
       ...
       receipt(index, row) {
        ...
        async determine() {
			...
			if(bean.showType=='add'){
				url='/account/broker/add';
			}else if(bean.showType=='update'){
				url='/account/broker/update';
			}
		...
		checkSubmit(bean){
			...
			if(commonUtils.isEmpty(bean.fName)){
				this.$message.error("经纪人简称不能为空");
				return false;
			}
			if(bean.fName.length>32){
				this.$message.error("经纪人简称不能超过32个字符");
				return false;
			}
			...
			if(commonUtils.isEmpty(bean.fGroupId)||bean.fGroupId<=0){
				this.$message.error("请选择经纪人分组");
				return false;
			}
