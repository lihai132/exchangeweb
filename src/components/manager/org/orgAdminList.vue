    ...
    <div class="BaseTable" @click="onMouseDown">
        <div class="container">
            <div class="head">
                ...
                <div class="head-two">
					...
					<div class="input2">
					    ...
					    <el-input v-model="query.fAdminName"  style="width:170px"></el-input>
					</div>
                    <div class="but">
            ...
            >
                ...
                <el-table-column :show-overflow-tooltip="true" prop="adminName" label="管理员名称" width="200" align="center"></el-table-column>
                <el-table-column :show-overflow-tooltip="true" prop="adminStatus" :formatter="statusFormat" label="账号状态" width="100" align="center"></el-table-column>
                <el-table-column :show-overflow-tooltip="true" prop="roleNames" label="所属角色" width="200" align="center"></el-table-column>
                <el-table-column :show-overflow-tooltip="true" prop="adminCreateTime" label="创建时间" align="center"></el-table-column>
                <el-table-column :show-overflow-tooltip="true" prop="adminDescn" label="描述" align="center"></el-table-column>
            </el-table>
            <div class="page">
                <el-pagination
...
import popup from './popup/resetOrgAdminPwdPop.vue';
export default {
    name: 'basetable',
    data() {
        return {
    ...
    methods: {
       ...
       async getData() {
		   ...
		   this.querying = true;
		   let list = await request('/account/org/adminList', this.query);
		   this.querying = true;
		   this.selectedRow='';
