    ...
    <div class="BaseTable" @click="onMouseDown">
        <div class="container">
            <div class="head">
				...
				<div class="head-two">
					<div class="input2">
					    <div class="title">客户账号：</div>
					    <el-input v-model="query.traderAccount" maxlength="32" style="width:170px"></el-input>
					</div>
					<div class="input2">
					    <div class="title">客户简称：</div>
            ...
            >
				...
				<el-table-column :show-overflow-tooltip="true" prop="traderCodeName" label="经纪人编号/简称" width="200" align="center"></el-table-column>
                <el-table-column :show-overflow-tooltip="true" prop="fMobile" label="客户账号" width="120" align="center"></el-table-column>
				<el-table-column :show-overflow-tooltip="true" prop="fName" label="客户简称" width="120" align="center"></el-table-column>
				<el-table-column :show-overflow-tooltip="true" prop="fCompanyName" label="企业名称" width="120" align="center"></el-table-column>
                <el-table-column :show-overflow-tooltip="true" prop="fTaxCode" label="信用代码" width="100" align="center"></el-table-column>
                <el-table-column :show-overflow-tooltip="true" prop="fCompanyAddress" label="单位地址" width="140" align="center"></el-table-column>
				<el-table-column :show-overflow-tooltip="true" prop="fCompanyPhone" label="企业电话" width="100" align="center"></el-table-column>
                <el-table-column :show-overflow-tooltip="true" prop="fOpenBank" label="开户银行" align="center"></el-table-column
				<el-table-column :show-overflow-tooltip="true" prop="fBankAccount" label="银行账户" align="center"></el-table-column>
                <el-table-column :show-overflow-tooltip="true" prop="fReceiveName" label="收件人" align="center"></el-table-column>
				<el-table-column :show-overflow-tooltip="true" prop="fReceiveMobile" label="收件电话" align="center"></el-table-column>
				<el-table-column :show-overflow-tooltip="true" prop="fPostCode" label="邮政编码" align="center"></el-table-column>
				<el-table-column :show-overflow-tooltip="true" prop="fPostAddress" label="邮寄地址" align="center"></el-table-column>
            </el-table>
            <div class="page">
                <el-pagination
...
import popup from './popup/updateBillInfoPop.vue';
...
export default {
    ...
    methods: {
       ...
       async getData() {
		   ...
		   this.querying = true;
		   let list = await request('/account/customer/billsInfoList', this.query);
		   this.querying = false;
		   this.selectedRow='';
		...
		async btnClick(item){
			if(item=='修改'){
				...
				//let bean = await request('/account/broker/detail', {"fTraderId":this.selectedRow.fTraderId});
