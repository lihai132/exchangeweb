                    ...
                    <div class="information">
                        <div class="news-noe">
                            ...
                            <div class="nav">
								...
								<div class="line" v-if="!alreadyCompany">
									<div class="line-center">
						...
						<div class="news-img">
						    ...
						    <div class="nav">
						        <el-upload
								  ...
								  <div slot="tip" class="el-upload__tip required" align="center">身份证(正面)</div>
						        </el-upload>
						        <el-dialog :visible.sync="dialogVisible">
						          <img width="100%" :src="dialogImageUrl" alt="">
						        </el-dialog>
								<div class="line" style="margin-left: 60px;">
									<div class="line-center" style="margin-top:50px;margin-left: 28px;">
									    <div class="name required" style="display: inline-block;">姓名：</div>
									    <el-input
									        size="small"
									        placeholder="请输入姓名"
							...
							<div class="nav">
								<el-upload
								  ...
								  >
								  <i class="el-icon-plus"></i>
								  <div slot="tip" class="el-upload__tip" align="center">身份证(反面)</div>
								</el-upload>
								<el-dialog :visible.sync="dialogVisible">
								  <img width="100%" :src="dialogImageUrl" alt="">
								</el-dialog>
						...
						<div class="news-img" v-if="bean.fTraderTypeChild==2">
						    <div class="title">
...
export default {
    ...
    methods: {
         receipt(index, row) {
			...
			this.bean = popup1;
			this.alreadyCompany = this.bean.fTraderTypeChild==2;
			if(this.bean.fTraderTypeChild){
				this.bean.fTraderTypeChild += '';
			}
			this.typeChildChange();
			this.listMembers();
		...
		typeChildChange(){
			if(this.bean.fTraderTypeChild==1){
				this.title = "申请个人实名认证";
			}else if(this.bean.fTraderTypeChild==2){
				this.title = "申请企业实名认证";
			}else{
				this.title = "申请实名认证";
			}
        ...
        async determine() {
			...
			let result = await request('/account/customer/askAuth', this.bean);
			this.submitting=false;
			if(result.data==1){
				this.editVisible = false;
		...
		checkSubmit(bean){
			...
			if(bean.fLegalName.length>64){
				this.$message.error("姓名不能超过64个字符");
				return false;
			}
