                ...
                <el-main>
					<div class="box" style="position: relative; overflow: auto;height:90%;">
					    ...
					    >
					        ...
					        <el-table-column :show-overflow-tooltip="true" prop="fMobile" label="客服账号" width="250" align="center"></el-table-column>
					        <el-table-column :show-overflow-tooltip="true" prop="fName" label="客服简称" width="250" align="center"></el-table-column>
					    </el-table>
					</div>
					<!-- <div class="page">
					    <el-pagination
...
export default {
    ...
    methods: {
		...
		async getData() {
			...
			let list = await request('/account/customerDispatch/customerOptions', this.query);
