<template>
    <div class="Popup">
        <el-dialog title="运营商申请实名认证" :visible.sync="editVisible" width="700px" :close-on-click-modal="false">
            <el-container>
                <el-main>
...
export default {
    ...
    methods: {
        ...
        async determine() {
			...
			let result = await request('/account/member/authentication', this.bean);
			this.submitting=false;
			if(result.data==1){
				this.editVisible = false;
