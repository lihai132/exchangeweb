<template>
    <div class="Popup">
        <el-dialog title="审核运营商实名认证" :visible.sync="editVisible" width="700px" :close-on-click-modal="false">
            ...
            <el-container>
				...
				                <div class="formatTittle">- 运营商信息</div>
				                <div class="formatTittleright"></div>
							</div> -->
							<div class="title">
							    <div class="left">运营商信息</div>
							</div>
                            <div class="nav">
								<div class="line">
...
export default {
    ...
    methods: {
        ...
        async determine(type) {
			...
			let result = await request('/account/member/doAuthCertification', {"fId":this.bean.fId,"opType":this.opType});
			this.submitting=false;
			if(result.data>=0){
				this.editVisible = false;
				if(type!='unpass'){
