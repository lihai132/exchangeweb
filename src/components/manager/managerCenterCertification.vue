    ...
    <div class="BaseTable" @click="onMouseDown">
        <div class="container">
            ...
            >
                ...
                <el-table-column :show-overflow-tooltip="true" prop="fCode" label="运营中心编号" width="200" align="center"></el-table-column>
                <el-table-column :show-overflow-tooltip="true" prop="fName" label="运营中心简称" width="240" align="center"></el-table-column>
                <el-table-column :show-overflow-tooltip="true" prop="fCenterStatus" :formatter="centerStatusFormat" label="运营中心状态" width="140" align="center"></el-table-column>
...
import doAuthPop from './doAuthPop.vue';
export default {
    name: 'basetable',
    data() {
        return {
    ...
    methods: {
       ...
       async getData() {
		   ...
		   this.querying = true;
		   let list = await request('/account/center/certificationList', this.query);
		   this.querying = false;
		   this.selectedRow='';
		...
		async btnClick(item,index){
			if(item=='审核实名认证'){
				...
				let bean = await request('/account/center/waitAuthCertificationDetail', {"fId":this.selectedRow.fId});
