    ...
    <div class="BaseTable1" @click="onMouseDown">
        <div class="container">
            ...
            >
                ...
                <el-table-column :show-overflow-tooltip="true" prop="fCarType" label="车型" align="center"></el-table-column>
				<el-table-column :show-overflow-tooltip="true" prop="fCarLength" label="车长" align="center"></el-table-column>
                <el-table-column :show-overflow-tooltip="true" prop="fRank" label="排名" align="center"></el-table-column>
				<el-table-column :show-overflow-tooltip="true" prop="fAmount" label="运输次数" align="center"></el-table-column>
            </el-table>
			<div class="page">
			    <el-pagination
...
export default {
    ...
    methods: {
       ...
       async getData() {
		   ...
		   this.resetData();
		   let res = await request('/statistics/others/userRate/carUserRateRank', this.query);
		   var datas = res.data;
