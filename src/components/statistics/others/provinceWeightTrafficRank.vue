    ...
    <div class="BaseTable1" @click="onMouseDown">
        <div class="container">
            ...
            >
                ...
                <el-table-column :show-overflow-tooltip="true" prop="province" label="省份" align="center"></el-table-column>
...
export default {
    ...
    methods: {
       ...
       async getData() {
		   ...
		   this.resetData();
		   let res = await request('/statistics/others/freightTraffic/provinceWeightTrafficRank', this.query);
		   var datas = res.data;
