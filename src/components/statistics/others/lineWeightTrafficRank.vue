    ...
    <div class="BaseTable1" @click="onMouseDown">
        <div class="container">
            <div class="head">
                 <div class="head-one">
					 <div class="input1">
					 	...
					 	<el-date-picker :type="dateType" :format="dateFormat" v-model="tradeDate" ref="tradeDate" @change="change()" placeholder="请选择年份">
					 	</el-date-picker>
					 </div>
					 
					 <div v-if="showRangeDate" class="input1" style="width: 161px;padding-left: 85px;">
            ...
            >
                ...
                <el-table-column :show-overflow-tooltip="true" prop="sourceCity" label="起始地" align="center"></el-table-column>
				<el-table-column :show-overflow-tooltip="true" prop="destCity" label="目的地" align="center"></el-table-column>
                <el-table-column :show-overflow-tooltip="true" prop="fRank" label="排名" align="center"></el-table-column>
				<el-table-column :show-overflow-tooltip="true" prop="fAmount" label="货运量" align="center"></el-table-column>
            </el-table>
			<div class="page">
			    <el-pagination
...
export default {
    ...
    methods: {
       ...
       async getData() {
		   ...
		   this.resetData();
		   let res = await request('/statistics/others/freightTraffic/lineWeightTrafficRank', this.query);
		   var datas = res.data;
