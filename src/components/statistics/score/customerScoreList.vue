    ...
    <div class="BaseTable" @click="onMouseDown">
        <div class="container">
            ...
            >
                ...
                <el-table-column :show-overflow-tooltip="true" prop="fMobile" label="客户账号"  align="center"></el-table-column>
				<el-table-column :show-overflow-tooltip="true" prop="fName" label="客户简称"  align="center"></el-table-column>
				<el-table-column :show-overflow-tooltip="true" prop="fFullName" label="企业名称"  align="center"></el-table-column>
...
export default {
    ...
    methods: {
       ...
       async getData() {
		   ...
		   let res = await request('/statistics/score/customer/customerScoreList', this.query);
           var datas = res.data;
