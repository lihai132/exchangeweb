    ...
    <div class="BaseTable" @click="onMouseDown">
        <div class="container">
            ...
            >
                ...
                <el-table-column :show-overflow-tooltip="true" prop="fMobile" label="司机账号"  align="center"></el-table-column>
				<el-table-column :show-overflow-tooltip="true" prop="fName" label="司机简称"  align="center"></el-table-column>
				<el-table-column :show-overflow-tooltip="true" prop="fCarNumber" label="车牌号"  align="center"></el-table-column>
				<el-table-column :show-overflow-tooltip="true" prop="fTotalCount" label="总评价数量" align="center"></el-table-column>
				<el-table-column :show-overflow-tooltip="true" prop="fGoodCount" label="好评"  align="center"></el-table-column>
                <el-table-column :show-overflow-tooltip="true" prop="fNomalCount" label="中评"  align="center"></el-table-column>
				<el-table-column :show-overflow-tooltip="true" prop="fBadCount" label="差评"  align="center"></el-table-column>
            </el-table>
            <div class="page">
                <el-pagination
...
export default {
    ...
    methods: {
       ...
       async getData() {
		   ...
		   let res = await request('/statistics/score/driver/driverScoreList', this.query);
           var datas = res.data;
