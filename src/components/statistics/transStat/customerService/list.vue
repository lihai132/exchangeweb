        ...
        <div class="container">
            <div class="head">
                <div class="head-one">
                 ...
                 <div class="head-two">
					 <div class="input1" style="width: 161px;padding-left: 85px;">
            ...
            >
                ...
                <el-table-column :show-overflow-tooltip="true" prop="newOrderCount" label="客服订单数量" align="center"></el-table-column>
                <el-table-column :show-overflow-tooltip="true" prop="newWaybillCount" label="新增运单数量" align="center"></el-table-column>
				<el-table-column :show-overflow-tooltip="true" prop="cancelWaybillCount" label="撤销运单数量" align="center"></el-table-column>
				<el-table-column :show-overflow-tooltip="true" prop="successWaybillCount" label="成交运单数量" align="center"></el-table-column>
				<el-table-column :show-overflow-tooltip="true" prop="successFreightAmount" label="成交运费金额" align="center"></el-table-column>
				<el-table-column :show-overflow-tooltip="true" prop="successChargeAmount" label="成交服务费金额" align="center"></el-table-column>
            </el-table>
			<div class="page">
			    <el-pagination
...
export default {
    ...
    data() {
		this.chartSettings = {
			axisSite: { right: ['successFreightAmount','successChargeAmount'] },
			yAxisName: ['交易量', '交易额'],
			labelMap: {
			  newOrderCount: '客服订单数量',
			  newWaybillCount: '新增运单数量',
			  successWaybillCount: '成交运单数量',
			  cancelWaybillCount: '撤销运单数量',
              successFreightAmount:'成交运费金额',
              successChargeAmount:'成交服务费金额'
			},
            showLine: ['successFreightAmount','successChargeAmount']
		}
        return {
            query: {
                page: 1,
			...
			chartData: {
			  columns: ['statTime', 'newOrderCount', 'newWaybillCount', 'cancelWaybillCount','successWaybillCount','successFreightAmount','successChargeAmount'],
			  rows: []
			},
            members:[],
			traders:[],
    ...
    methods: {
       ...
       async getData() {
		   ...
		   if(!(this.query.fTraderId>0)){
			   this.$refs.fTraderId.$el.children[0].children[0].focus();
			   return false;
		   }
		   ...
		   this.resetData();
		   let res = await request('/statistics/trans/trader/traderTransList', this.query);
		   var datas = res.data;
		...
		async dealerChange(isInit){
			...
			this.traders = (await request('/statistics/trans/traders/listCustomerService', {'fDealerId':id})).data;
