    ...
    <div class="BaseTable1" @click="onMouseDown">
        <div class="container">
            ...
            >
                ...
                <el-table-column :show-overflow-tooltip="true" prop="newOrderCount" label="新增订单数量" align="center"></el-table-column>
...
export default {
    ...
    methods: {
       ...
       async getData() {
		   ...
		   this.resetData();
		   let res = await request('/statistics/trans/dealer/dealerTransList', this.query);
		   var datas = res.data;
