        ...
        <div class="container">
            <div class="head">
                <div class="head-one">
					...
					<div class="input1">
					  <div class="title">经纪人：</div>
						<el-select
						    v-model="query.fTraderId"
						    class="handle-select"
						    style="width:180px"
							placeholder="请搜索/选择经纪人"
							filterable
							ref="fTraderId"
							@change="change()"
						>
...
export default {
    ...
    data() {
		this.chartSettings = {
			axisSite: { right: ['successFreightAmount'] },
			yAxisName: ['交易量', '交易额'],
			labelMap: {
        ...
        return {
			...
			chartData: {
			  columns: ['statTime', 'newOrderCount', 'newWaybillCount', 'cancelWaybillCount','successWaybillCount','successFreightAmount'],
			  rows: []
			},
            members:[],
			traders:[],
    ...
    methods: {
       ...
       async getData() {
		...
		async dealerChange(isInit){
			...
			this.traders = (await request('/statistics/trans/traders/listBrokers', {'fDealerId':id})).data;
