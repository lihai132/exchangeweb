...
export default {
    ...
    data() {
        ...
        return {
			...
			chartData: {
			  columns: ['statTime', 'newWaybillCount', 'cancelWaybillCount','successWaybillCount','successFreightAmount','successChargeAmount'],
			  rows: []
			},
            members:[],
			traders:[],
    ...
    methods: {
       ...
       async getData() {
		...
		async dealerChange(isInit){
			...
			this.traders = (await request('/statistics/trans/traders/listDrivers', {'fDealerId':id})).data;
