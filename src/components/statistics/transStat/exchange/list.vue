...
export default {
    ...
    data() {
        ...
        return {
			...
			chartData: {
			  columns: ['statTime', 'newOrderCount', 'newWaybillCount', 'successWaybillCount','successFreightAmount','successChargeAmount'],
			  rows: []
			},
			dateType:'',
    ...
    methods: {
       ...
       async getData() {
		   ...
		   let res = await request('/statistics/trans/plat/platTransList', this.query);
		   var datas = res.data;
