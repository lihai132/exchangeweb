			...
			<el-tabs v-model="activeTapName" @tab-click="tabClick">
				<el-tab-pane label="成交量" name="count">
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" prop="fTraderName" label="客户简称" align="center"></el-table-column>
				...
				<el-tab-pane v-if="false" label="收入" name="charge">
					<el-table
...
export default {
    ...
    methods: {
       ...
       async getData() {
		   ...
		   let res = await request('/statistics/rank/trader/customerRankList', this.query);
		   var datas = res.data;
