...
export default {
    ...
    methods: {
       ...
       async getData() {
		   ...
		   let res = await request('/statistics/rank/member/memberRankList', this.query);
		   var datas = res.data;
