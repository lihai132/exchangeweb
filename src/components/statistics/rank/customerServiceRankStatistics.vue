			...
			<el-tabs v-model="activeTapName" @tab-click="tabClick">
				<el-tab-pane label="成交量" name="count">
					...
					>
						...
						<el-table-column :show-overflow-tooltip="true" prop="fTraderName" label="客服简称" align="center"></el-table-column>
...
export default {
    ...
    methods: {
       ...
       async getData() {
		   ...
		   let res = await request('/statistics/rank/trader/customerServiceRankList', this.query);
		   var datas = res.data;
