    ...
    <div class="BaseTable1" @click="onMouseDown">
        <div class="container">
            ...
            >
                ...
                <el-table-column :show-overflow-tooltip="true" prop="fTodayOpenUser" label="新增客户数量" align="center"></el-table-column>
                <el-table-column :show-overflow-tooltip="true" prop="fTodayAuthUser" label="新增认证客户数量" align="center"></el-table-column>
				<el-table-column :show-overflow-tooltip="true" prop="fOpenUserSum" label="总客户数量" align="center"></el-table-column>
				<el-table-column :show-overflow-tooltip="true" prop="fAuthUserSum" label="总认证客户数量" align="center"></el-table-column>
            </el-table>
			<div class="page">
			    <el-pagination
...
export default {
    ...
    data() {
		this.chartSettings = {
			...
			yAxisName: ['新增数量', '总数量'],
			labelMap: {
			  fAuthUserSum: '总认证客户数量',
			  fOpenUserSum: '总客户数量',
			  fTodayOpenUser: '新增认证客户数量',
			  fTodayAuthUser: '新增客户数量'
			},
   ...
   async created() {
    ...
    methods: {
       ...
       async getData() {
		   ...
		   this.resetData();
		   let res = await request('/statistics/users/member/memberUserList', this.query);
		   var datas = res.data;
