    ...
    <div class="BaseTable1" @click="onMouseDown">
        <div class="container">
            ...
            >
                ...
                <el-table-column :show-overflow-tooltip="true" prop="fTodayOpenUser" label="新增司机数量" align="center"></el-table-column>
                <el-table-column :show-overflow-tooltip="true" prop="fTodayAuthUser" label="新增认证司机数量" align="center"></el-table-column>
				<el-table-column :show-overflow-tooltip="true" prop="fOpenUserSum" label="总司机数量" align="center"></el-table-column>
				<el-table-column :show-overflow-tooltip="true" prop="fAuthUserSum" label="总认证司机数量" align="center"></el-table-column>
            </el-table>
			<div class="page">
			    <el-pagination
...
export default {
    ...
    data() {
		this.chartSettings = {
			axisSite: { right: ['fOpenUserSum','fAuthUserSum'] },
			yAxisName: ['新增数量', '总数量'],
			labelMap: {
			  fAuthUserSum: '总认证司机数量',
			  fOpenUserSum: '总司机数量',
			  fTodayOpenUser: '新增认证司机数量',
			  fTodayAuthUser: '新增司机数量'
			},
			showLine: ['fAuthUserSum','fOpenUserSum']
		}
        return {
            query: {
                page: 1,
			...
			chartData: {
			  columns: ['statTime', 'fTodayOpenUser', 'fTodayAuthUser', 'fOpenUserSum', 'fAuthUserSum'],
			  rows: []
			},
			dateType:'',
    ...
    async created() {
		...
		this.statTypeChange();
        this.getBut();
		let members = await request('/statistics/users/member/listAllMembers',{});
    ...
    methods: {
       ...
       async getData() {
		   ...
		   this.query.fDealerId = this.fDealerId;
		   this.resetData();
		   let res = await request('/statistics/users/member/memberDriverList', this.query);
		   var datas = res.data;
