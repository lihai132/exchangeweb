    ...
    <div class="BaseTable1" @click="onMouseDown">
        <div class="container">
            ...
            >
				...
				<el-table-column :show-overflow-tooltip="true" prop="fName" label="客服名称" align="center"></el-table-column>
				<el-table-column :show-overflow-tooltip="true" prop="fMobile" label="客服电话" align="center"></el-table-column>			
...
export default {
    ...
    methods: {
       ...
       async getData() {
		   ...
		   this.resetData();
		   let res = await request('/statistics/kpi/trader/customerServiceKPI', this.query);
		   var datas = res.data;
