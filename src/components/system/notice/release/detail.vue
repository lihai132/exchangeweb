                    ...
                    <div class="information">
                        <div class="news-noe">
                            ...
                            <el-form ref="dataForm" :rules="rules"  label-suffix=":" :model="data" label-width="130px">
                                ...
                                <el-form-item prop="fEndTime" label="结束时间" >
                                    <el-date-picker :disabled="true"
                                    v-model="data.fEndTime"
                                    type="datetime"
                                    placeholder="选择日期时间">
                                    </el-date-picker>
                                </el-form-item>
                                <el-form-item prop="fTitle" label="标题" >
                                    <el-input v-model="data.fTitle" :disabled="true" style="width:215px;" required></el-input>
                                </el-form-item>
                                <el-form-item prop="fReceive" label="收件对象" >
                                    <el-checkbox-group  
                                        v-model="data.fReceive">
                                        <el-checkbox 
                                        v-for="obj in noticeType" 
                                        v-if="obj.key != -1" 
                                        :label="obj.value" 
                                ...
                                <el-form-item prop="fContent"  label="内容" required>
                                    <el-input type="textarea" :disabled="true" rows="10" v-model="data.fContent" style="width:400px;"></el-input>
                                </el-form-item>
...
export default {
    ...
    methods: {
        ...
        async getData() {
			...
			let temp = (await request('/systemManager/notice/detail', {fId:this.data.fId})).data;
            if(temp != null){
                this.data = temp;
            }
