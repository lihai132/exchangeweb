        ...
        <div class="container">
                <el-form label-suffix=":"  ref="query" :model="query" label-width="90px">
                    <div style="width:800px;">
                            <el-form-item prop="fTitle"  style="width:230px;display:inline-block;margin-right:20px;" label="标题">
                               <el-input v-model="query.fTitle" placeholder="请输入内容"></el-input>
                            </el-form-item>

                            <el-form-item prop="fStatus"  style="width:230px;display:inline-block;margin-right:20px;" label="状态">
                                <el-select v-model="query.fStatus"  :clearable="true">
                                        <el-option label="全部" value="-1"> </el-option>
										<el-option
                                        v-for="item in this.certificationStatus"
                                        :key="item.key"
                                        :label="item.value"
                                        :value="item.key">
                                        </el-option>
                ...
                <el-table :data="tableData"  border class="table" ref="multipleTable" header-cell-class-name="table-header" highlight-current-row @row-click="clickTableRow" @current-change="selectChage" @row-contextmenu="rightClick" :summary-method="getSummaries" show-summary>
                    ...
                    <el-table-column :show-overflow-tooltip="true"  prop="fTitle" label="标题" width="180" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fContent" label="内容" width="180" align="center"> </el-table-column>
                    ...
                    <el-table-column :show-overflow-tooltip="true"  prop="fSenderAccount" label="发布人" width="140" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fAuthor" label="发布单位" width="140" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  :formatter="formatfType" prop="fDealercateId" label="收件对象" width="140" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fCreateTime" label="创建时间" width="160" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fUpdateTime" label="审核时间" width="160" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fAuditerAccount" label="审核人" width="160" align="center"> </el-table-column>
                </el-table>
                <div class="page">
...
export default {
    ...
    methods: {
        ...
        // 获取表格数据
        async init() {
            this.certificationStatus = (await request('/enum/certificationStatus/api', this.query)).data;  
            this.noticeType = (await request('/enum/noticeType/api', this.query)).data;  
            this.getData();
        },
        // 获取表格数据
        async getData() {
			...
			this.querying = true;
            var jsonData = (await request('/systemManager/notice/audit/list', this.query)).data;
			this.querying = false;
        ...
        formatfStatus(row) {
            return tool.getEnumValue(this.certificationStatus, row.fStatus);
        },
        //点击弹窗事件
        receipt(index, row) {
            this.editVisible = true;
      ...
      formatfType(row){
        return tool.getEnumValue(this.noticeType,row.fDealercateId);
      }
      ,
