        ...
        <div class="container">
                <el-form label-suffix=":"  ref="query" :model="query" label-width="90px">
                    ...
                    <div style="width:800px;">
                            <el-form-item prop="fCreateTime"  style="width:280px;display:inline-block;margin-right:20px;" label="成交日期">
                ...
                >
                    ...
                    <el-table-column :show-overflow-tooltip="true"  prop="fFreight"  label="价格(元)" width="80" align="center"> </el-table-column>
                    ...
                    <el-table-column :show-overflow-tooltip="true"  prop="fMobile"   label="承运人电话" width="120" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fName"   label="承运人名称" width="120" align="center"> </el-table-column>
...
export default {
    ...
    methods: {
        ...
        async getData() {
			...
			this.querying = true;
            var jsonData = (await request('/report/other/systemhq/list', this.query)).data;
			this.querying = false;
