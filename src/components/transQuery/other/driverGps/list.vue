<template>
    <div class="BaseTable" @click="onMouseDown">
        <div class="container">
                <el-form label-suffix=":"  ref="query" :model="query" label-width="110px">
                    <div style="width:1000px;">
                            <el-form-item prop="fMobile"  style="width:280px;display:inline-block;margin-right:20px;" label="司机账号/简称">
                               <el-input v-model="query.fMobile" placeholder="请输入内容"></el-input>
                            </el-form-item>
                           <el-form-item prop="carName"  style="width:280px;display:inline-block;margin-right:20px;" label="车牌号">
                               <el-input v-model="query.carName" placeholder="请输入内容"></el-input>
                            </el-form-item>
							<el-form-item prop="fWaybillCode"  style="width:280px;display:inline-block;margin-right:20px;" label="运单号">
							   <el-input v-model="query.fWaybillCode" placeholder="请输入内容"></el-input>
							</el-form-item>
                   </div>         
                    <div style="width:1000px;">
                            <el-form-item prop="fCreateTime"  style="width:280px;display:inline-block;margin-right:20px;" label="定位日期">
                ...
                >
                    ...
                    <el-table-column :show-overflow-tooltip="true"  prop="fMobile"  label="司机账号" width="120" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fName"  label="司机简称" width="120" align="center"> </el-table-column>
                   
                    <el-table-column :show-overflow-tooltip="true"  prop="fAddress"  label="定位地址" width="300" align="left"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fCreateTime"  label="定位时间" width="160" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="carName"  label="关联车牌号" width="120" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fWaybillCode"  label="关联运单号" width="150" align="center"> </el-table-column>
					 <el-table-column :show-overflow-tooltip="true"  prop="fLongitude"  label="经度" width="100" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fLatitude"  label="维度" width="150" align="center"> </el-table-column>
...
export default {
    ...
    methods: {
        ...
        async getData() {
			...
			this.querying = true;
            var jsonData = (await request('/report/other/driverGps/list', this.query)).data;
			this.querying = false;
