        ...
        <div class="container">
                    ...
                    <div style="width:1000px;">
                     ...
                     <div style="width:1000px;">
						 <el-form-item label="创建日期" style="width:280px;display:inline-block;margin-right:20px;" prop="fCreateDate">
                            ...
                            <el-form-item prop="fOrderTraderType"  style="width:280px;display:inline-block;margin-right:20px;" label="订单来源">
                                <el-select v-model="query.fOrderTraderType"  :clearable="true">
                            		<el-option label="全部" value="-1"> </el-option>
                                        <el-option
                                        v-for="item in this.orderTraderType"
                                        :key="item.key"
                                        :label="item.value"
                                        :value="item.key">
                                        </el-option>
                ...
                >
                   ...
                   <el-table-column :show-overflow-tooltip="true"  prop="memberName"  label="运营商简称" width="180" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fOrderCode"  label="订单编号" width="120" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fOrderStatus" :formatter="fMoneyOrderAllStatus"  label="订单状态" width="80" align="center"> </el-table-column>
                    ...
                    <el-table-column :show-overflow-tooltip="true"  prop="fOrderTraderType" :formatter="formatfOrderTraderType"  label="订单来源" width="120" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fSendAddr"  label="起运地" width="180" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fReceiveAddr"  label="目的地" width="180" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fGoodsName"  label="货物名称" width="120" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fFreightExpect"  label="期望运费(元)" width="120" align="center"> </el-table-column>
...
export default {
    ...
    methods: {
        ...
        async init() {
            ...
            this.orderTraderType = (await request('/enum/orderTraderType/api', this.query)).data;
			this.getData();
        },
        // 获取表格数据
        async getData() {
			...
			this.querying = true;
            var jsonData = (await request('/report/member/order/list', this.query)).data;
			this.querying = false;
            if(jsonData != null){
        ...
        buttonClick(item) {
            if(item == '导出'){
				...
				//要转换的字段
				var mapKey = {};
				mapKey["fOrderStatus"] = this.orderAllStatus;
				mapKey["fOrderTraderType"] = this.orderTraderType;
                ...
                //this.query.export = 0;
                 requestExport('/report/member/order/list', this.query).then(response => { 
        ...
        formatfOrderTraderType(row) {
            return tool.getEnumValue(this.orderTraderType, row.fOrderTraderType);
        },
        //点击弹窗事件
        receipt(index, row) {
            this.editVisible = true;
