        ...
        <div class="container">
                <el-form label-suffix=":"  ref="query" :model="query" label-width="120px">
                    <div style="width:800px;">
                            <el-form-item prop="mobileOrCode"  style="width:280px;display:inline-block;margin-right:20px;" label="运营商编号/简称">
                ...
                <div class="from-head" v-if="menus&&menus.length>0">
                ...
                show-summary>
                    ...
                    <el-table-column :show-overflow-tooltip="true"  prop="mobileOrCode"  label="运营商编号" width="180" align="center"> </el-table-column>
                    ...
                    <el-table-column :show-overflow-tooltip="true"  prop="fChargeIn"  label="今日服务费收益" width="150" align="center"> </el-table-column>
...
export default {
    ...
    methods: {
        ...
        async getData() {
			...
			this.querying = true;
            var jsonData = (await request('/report/member/money/list', this.query)).data;
			this.querying = false;
        ...
        buttonClick(item) {
            ...
            if(item == '导出'){
                ...
                //this.query.export = 0;
                 requestExport('/report/member/money/list', this.query).then(response => { 
