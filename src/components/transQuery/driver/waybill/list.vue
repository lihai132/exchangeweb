        ...
        <div class="container">
                <el-form label-suffix=":"  ref="query" :model="query" label-width="120px">
                    <div style="width:1000px;">
                            ...
                            <el-form-item prop="traderName"  style="width:280px;display:inline-block;margin-right:20px;" label="司机账号/简称">
                               <el-input v-model="query.traderName" placeholder="请输入内容"></el-input>
                            </el-form-item>
                            <el-form-item prop="carNumber"  style="width:280px;display:inline-block;margin-right:20px;" label="车牌号">
                               <el-input v-model="query.carNumber" placeholder="请输入内容"></el-input>
                            </el-form-item>
                    </div>
                     <div style="width:1000px;">
                ...
                >
                    ...
                    <el-table-column :show-overflow-tooltip="true"  prop="fDriverMobile" label="司机账号" width="120" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fDriverName" label="司机简称" width="120" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fCarNumber"  label="车牌号" width="100" align="center"> </el-table-column>
...
export default {
    ...
    methods: {
        ...
        async getData() {
			...
			this.querying = true;
            var jsonData = (await request('/report/driver/waybill/list', this.query)).data;
			this.querying = false;
            if(jsonData != null){
        ...
        buttonClick(item) {
            if(item == '导出'){
                ...
                //this.query.export = 0;
                 requestExport('/report/driver/waybill/list', this.query).then(response => { 
