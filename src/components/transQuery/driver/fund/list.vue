        ...
        <div class="container">
                <el-form label-suffix=":"  ref="query" :model="query" label-width="120px">
                    <div style="width:1260px;">
							...
							<el-form-item prop="dealerName"  style="width:280px;display:inline-block;margin-right:20px;" label="车牌号">
							   <el-input v-model="query.dealerName" placeholder="请输入内容"></el-input>
							</el-form-item>
							<el-form-item style="width:340px;display:inline-block;margin-right:20px;">
                ...
                >
                    ...
                    <el-table-column :show-overflow-tooltip="true"  prop="dealerName"  label="车牌号" width="180" align="center"> </el-table-column>
                    ...
                    <el-table-column :show-overflow-tooltip="true"  prop="fReward"  label="今天推广奖励" width="150" align="center"> </el-table-column>
...
export default {
    ...
    methods: {
        ...
        async getData() {
			...
			this.querying = true;
            var jsonData = (await request('/report/driver/money/list', this.query)).data;
			this.querying = false;
        ...
        buttonClick(item) {
            ...
            if(item == '导出'){
                ...
                //this.query.export = 0;
                 requestExport('/report/driver/money/list', this.query).then(response => { 
