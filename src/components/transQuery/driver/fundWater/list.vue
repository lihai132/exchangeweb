        ...
        <div class="container">
                <el-form label-suffix=":"  ref="query" :model="query" label-width="120px">
                    <div style="width:1000px;">
                            ...
                            <el-form-item prop="mobileOrCode"  style="width:280px;display:inline-block;margin-right:20px;" label="司机账号/简称">
                               <el-input v-model="query.mobileOrCode" placeholder="请输入内容"></el-input>
                            </el-form-item>
                            <el-form-item prop="fCarNumber"  style="width:280px;display:inline-block;margin-right:20px;" label="车牌号">
                               <el-input v-model="query.fCarNumber" placeholder="请输入内容"></el-input>
                            </el-form-item>
                    </div>
                     <div style="width:1000px;">
                ...
                >
                    ...
                    <el-table-column :show-overflow-tooltip="true"  prop="mobileOrCode"  label="司机账号" width="180" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fName"  label="司机简称" width="180" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fCarNumber"  label="车牌号" width="180" align="center"> </el-table-column>
...
export default {
    ...
    methods: {
        ...
        // 获取表格数据
        async init() {
            this.moneyWaterType = (await request('/enum/diverMoneyWater/api', this.query)).data;
			this.getData();
        },
        // 获取表格数据
        async getData() {
			...
			this.querying = true;
            this.query.keyTransfor = 0;
            var jsonData = (await request('/report/driver/moneyWater/list', this.query)).data;
			this.querying = false;
            if(jsonData != null){
        ...
        buttonClick(item) {
            if(item == '导出'){
                ...
                //要转换的字段
                var mapKey = {};
                mapKey["fFlowType"] = this.moneyWaterType;
                ...
                //this.query.export = 0;
                 requestExport('/report/driver/moneyWater/list', this.query).then(response => { 
