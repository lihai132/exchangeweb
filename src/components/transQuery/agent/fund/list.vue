        ...
        <div class="container">
                <el-form label-suffix=":"  ref="query" :model="query" label-width="120px">
                    <div style="width:1000px;">
                            ...
                            <el-form-item style="width:320px;display:inline-block;margin-right:20px;">
                ...
                show-summary>
                    ...
                    <el-table-column :show-overflow-tooltip="true"  prop="mobileOrCode"  label="经纪人账号" width="180" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fName"  label="经纪人简称" width="180" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fPrevBalance"  label="期初余额" width="150" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fFareIn"  label="今日代收运费" width="150" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fRfFareIn"  label="今日运费退款" width="150" align="center"> </el-table-column>
...
export default {
    ...
    methods: {
        ...
        async getData() {
			...
			this.querying = true;
            var jsonData = (await request('/report/agent/money/list', this.query)).data;
			this.querying = false;
        ...
        buttonClick(item) {
            ...
            if(item == '导出'){
                ...
                //this.query.export = 0;
                 requestExport('/report/agent/money/list', this.query).then(response => { 
