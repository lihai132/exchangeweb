        ...
        <div class="container">
                <el-form label-suffix=":"  ref="query" :model="query" label-width="120px">
                    <div style="width:1000px;">
                            ...
                            <el-form-item prop="mobileOrCode"  style="width:280px;display:inline-block;margin-right:20px;" label="经纪人账号/简称">
                     ...
                     <div style="width:1230px;">
                            <el-form-item prop="fOrderTraderType"  style="width:280px;display:inline-block;margin-right:20px;" label="订单来源">
                                <el-select v-model="query.fOrderTraderType"  :clearable="true">
									<el-option label="全部" value="-1"> </el-option>
                                        <el-option
                                        v-for="item in this.ioOrderSoureType"
                                        :key="item.key"
                                        :label="item.value"
                                        :value="item.key">
                                        </el-option>
							...
							<el-form-item style="width:320px;display:inline-block;">
                ...
                @row-contextmenu="rightClick">
                    ...
                    <el-table-column :show-overflow-tooltip="true"  prop="memberCode"  label="运营商编号" width="180" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="memberName"  label="运营商简称" width="180" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fCustomerserviceMobile"  label="经纪人账号" width="180" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fCustomerserviceName"  label="经纪人简称" width="180" align="center"> </el-table-column>
                    ...
                    <el-table-column :show-overflow-tooltip="true"  prop="fOrderTraderType" :formatter="formatfOrderTraderType"  label="订单来源" width="150" align="center"> </el-table-column>
...
export default {
    ...
    methods: {
        ...
        async init() {
            ...
            this.ioOrderSoureType = (await request('/enum/ioOrderSoureType/api', this.query)).data;
			this.getData();
        },
        // 获取表格数据
        async getData() {
			...
			this.querying = true;
            var jsonData = (await request('/report/agent/order/list', this.query)).data;
			this.querying = false;
            if(jsonData != null){
        ...
        buttonClick(item) {
            if(item == '导出'){
				...
				mapKey["fOrderTraderType"] = this.ioOrderSoureType;
                ...
                //this.query.export = 0;
                 requestExport('/report/agent/order/list', this.query).then(response => { 
		...
		formatfOrderTraderType(row) {
            return tool.getEnumValue(this.ioOrderSoureType, row.fOrderTraderType);
        },
		formatFreightExpect(row){
			return row.fFreightExpect+'元';
		},
        //点击弹窗事件
        receipt(index, row) {
            this.editVisible = true;
