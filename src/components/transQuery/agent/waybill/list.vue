        ...
        <div class="container">
                <el-form label-suffix=":"  ref="query" :model="query" label-width="120px">
                    <div style="width:1000px;">
                            ...
                            <el-form-item prop="fDispatcherName"  style="width:280px;display:inline-block;margin-right:20px;" label="经纪人账号/简称">
                ...
                >
                    ...
                    <el-table-column :show-overflow-tooltip="true"  prop="fDispatcherMobile" label="经纪人账号" width="120" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fDispatcherName" label="经纪人简称" width="120" align="center"> </el-table-column>
                    ...
                    <el-table-column :show-overflow-tooltip="true"  prop="fCharge"  label="服务费/元" width="100" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fFreight"  label="运费/元" width="100" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fFreightPayed"  label="已付运费/元" width="100" align="center"> </el-table-column>
...
export default {
    ...
    methods: {
        ...
        async getData() {
			...
			this.querying = true;
            var jsonData = (await request('/report/agent/waybill/list', this.query)).data;
			this.querying = false;
            if(jsonData != null){
        ...
        buttonClick(item) {
            if(item == '导出'){
                ...
                //this.query.export = 0;
                 requestExport('/report/agent/waybill/list', this.query).then(response => { 
