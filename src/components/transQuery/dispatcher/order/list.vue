    ...
    <div class="BaseTable" @click="onMouseDown">
        <div class="container">
                ...
                show-summary>
                    ...
                    <el-table-column :show-overflow-tooltip="true"  prop="fFreightExpect"  label="期望运费" width="180" align="center"> </el-table-column>
...
export default {
    ...
    methods: {
        ...
        async getData() {
			...
			this.querying = true;
            var jsonData = (await request('/report/dispatcher/order/list', this.query)).data;
			this.querying = false;
            if(jsonData != null){
