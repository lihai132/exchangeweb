        ...
        <div class="container">
                <el-form label-suffix=":"  ref="query" :model="query" label-width="120px">
                    <div style="width:1250px;">
                            ...
                            <el-form-item prop="mobileOrCode"  style="width:280px;display:inline-block;margin-right:20px;" label="客户账号/简称">
                               <el-input v-model="query.mobileOrCode" placeholder="请输入内容"></el-input>
                            </el-form-item>
							<el-form-item prop="dealerName"  style="width:280px;display:inline-block;margin-right:20px;" label="企业名称">
							   <el-input v-model="query.dealerName" placeholder="请输入内容"></el-input>
							</el-form-item>
                ...
                show-summary>
                    ...
                    <el-table-column :show-overflow-tooltip="true"  prop="mobileOrCode" label="客户账号" width="180" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fName"  label="客户简称" width="180" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="dealerName"  label="企业名称" width="180" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fPayFare"  label="今日支付运费" width="150" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fBackFare"  label="今日返还运费" width="150" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fPayTax"  label="今日支付税费" width="150" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fBackTax"  label="今日返还税费" width="150" align="center"> </el-table-column>
					<el-table-column :show-overflow-tooltip="true"  prop="fIoChargeOut"  label="今日支付银行服务费" width="150" align="center"> </el-table-column>
                </el-table>
...
export default {
    ...
    methods: {
        ...
        async getData() {
			...
			this.querying = true;
            var jsonData = (await request('/report/customer/money/list', this.query)).data;
			this.querying = false;
        ...
        buttonClick(item) {
            ...
            if(item == '导出'){
                ...
                //this.query.export = 0;
                 requestExport('/report/customer/money/list', this.query).then(response => { 
