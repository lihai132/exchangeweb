<template>
    <div class="BaseTable" @click="onMouseDown">
        <div class="container">
                <el-form label-suffix=":"  ref="query" :model="query" label-width="130px">
                    <div style="width:1000px;">
                            ...
                            <el-form-item prop="traderName"  style="width:280px;display:inline-block;margin-right:20px;" label="客户账号/简称">
                               <el-input v-model="query.traderName" placeholder="请输入内容"></el-input>
                            </el-form-item>
                            <el-form-item prop="sendCompany"  style="width:280px;display:inline-block;margin-right:20px;" label="企业名称">
                               <el-input v-model="query.sendCompany" placeholder="请输入内容"></el-input>
                            </el-form-item>
                    </div>
                     <div style="width:1000px;">
                    ...
                    <div style="width:1320;">
							...
							<!--
							<el-form-item prop="fWaybillType"  style="width:280px;display:inline-block;margin-right:20px;" label="运单类型">
                               
                                <el-select v-model="query.fWaybillType"  :clearable="true">
									<el-option label="全部" value="-1"> </el-option>
                                        <el-option
                                        v-for="item in this.waybillType"
                                        :key="item.key"
                                        :label="item.value"
                                        :value="item.key">
                                        </el-option>
                            ...
                            <el-form-item style="width:330px;display:inline-block;">
                ...
                >
                    ...
                    <el-table-column :show-overflow-tooltip="true"  prop="memberName"  label="运营商简称" width="180" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fTraderMobile"  label="客户账号" width="120" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fTraderName"  label="客户简称" width="120" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fSendCompany"  label="企业名称" width="180" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fOrderCode"  label="关联订单号" width="130" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fWaybillCode"  label="运单编号" width="130" align="center"> </el-table-column>
                    ...
                    <el-table-column :show-overflow-tooltip="true"  prop="sendName"   label="起运地" width="180" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="receName"   label="目的地" width="180" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fGoodsName"   label="货物名称" width="180" align="center"> </el-table-column>
					<el-table-column :show-overflow-tooltip="true"  prop="fWaybillType" :formatter="waybillTypeFormatter"  label="运单类型" width="80" align="center"> </el-table-column>
					...
					<el-table-column :show-overflow-tooltip="true"  prop="fCharge"  label="服务费（元）" width="150" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fFreight" label="运费（元）" width="120" align="center"> </el-table-column>
...
export default {
    ...
    methods: {
        ...
        async init() {
			...
			this.waybillTypeDic = (await request('/enum/waybillType/api', this.query)).data;
        ...
        async getData() {
			...
			this.querying = true;
            var jsonData = (await request('/report/customer/waybill/list', this.query)).data;
			this.querying = false;
            if(jsonData != null){
        ...
        buttonClick(item) {
            if(item == '导出'){
                ...
                //this.query.export = 0;
                 requestExport('/report/customer/waybill/list', this.query).then(response => { 
		...
		waybillTypeFormatter(row) {
            return tool.getEnumValue(this.waybillTypeDic, row.fWaybillType);
        },
        //点击弹窗事件
        receipt(index, row) {
            this.editVisible = true;
