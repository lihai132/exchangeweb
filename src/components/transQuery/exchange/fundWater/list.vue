        ...
        <div class="container">
            <el-form label-suffix=":" ref="query" :model="query" label-width="100px">
                <div style="width:1230px;">
                    <el-form-item
                        prop="fRelationNo"
                        style="width:280px;display:inline-block;margin-right:20px;"
                        label="关联运单编号"
                    >
                ...
                <div style="width:1000px;">
                    ...
                    <el-form-item style="width:300px;display:inline-block;">
                        <el-button
                            type="primary"
                            style="width:90px;"
                            @click="query.page=1;submitForm('query')"
                        >查询</el-button>
...
export default {
    ...
    methods: {
        ...
        // 获取表格数据
        async init() {
            this.moneyWaterType = (await request('/enum/ioFlagExchange/api', this.query)).data;
			this.getData();
        },
        // 获取表格数据
        async getData() {
            ...
            this.querying = true;
            var jsonData = (await request('/report/exchange/moneyWater/list', this.query)).data;
            this.querying = false;
            if (jsonData != null) {
