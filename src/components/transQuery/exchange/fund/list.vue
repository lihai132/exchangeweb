    ...
    <div class="BaseTable" @click="onMouseDown">
        ...
        <div class="container">
                <el-form label-suffix=":"  ref="query" :model="query" label-width="90px">
                    <div style="width:800px;">
                            <el-form-item style="width:280px;display:inline-block;margin-right:20px;">
                                <el-button type="primary" style="width:90px;"  @click="query.page=1;submitForm('query')">刷新</el-button>
                            </el-form-item>
                    </div>
                </el-form>
                <div class="from-head">
                ...
                >
                    ...
                    <el-table-column :show-overflow-tooltip="true"  prop="mobileOrCode"  label="交易中心编号" width="180" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fName"  label="交易中心简称" width="180" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fPrevBalance"  label="期初余额" width="150" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fChargeIn"  label="今日新增平台服务费" width="150" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fIoChargeOut"  label="今日新增银行服务费" width="150" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fAmountOut"  label="今日提现" width="150" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fBalance"  label="今日余额" width="150" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fPayFare"  label="运费支出" width="150" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fTaxOut"  label="税费支出" width="150" align="center"> </el-table-column>
                </el-table>
...
export default {
    ...
    methods: {
        ...
        async getData() {
			...
			this.querying = true;
            var jsonData = (await request('/report/exchange/money/list', this.query)).data;
			this.querying = false;
        ...
        buttonClick(item) {
            ...
            if(item == '导出'){
                ...
                //this.query.export = 0;
                 requestExport('/report/exchange/money/list', this.query).then(response => { 
