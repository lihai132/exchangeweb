        ...
        <el-dialog  v-bind:title="title"   :visible.sync="editVisible" width="800px" height="1000px" :close-on-click-modal="false">
            <el-container>
                ...
                show-summary>
					...
					<el-table-column :show-overflow-tooltip="true"  prop="fBankCharge"  label="今日银行服务费收益" width="150" align="center"> </el-table-column>
...
export default {
    ...
    methods: {
        ...
        async getData() {
			let temp = (await request('/report/exchange/moneyHis/list', this.query)).data;
            if(temp != null){
		...
		buttonClick(item) {
				    if(item == '导出'){
				        ...
				        //this.query.export = 0;
				         requestExport('/report/exchange/moneyHis/list', this.query).then(response => { 
