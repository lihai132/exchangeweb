    ...
    <div class="BaseTable" @click="onMouseDown">
        <div class="container">
                ...
                show-summary>
                    ...
                    <el-table-column :show-overflow-tooltip="true"  prop="fPendingOut"  label="今日服务费划转" width="150" align="center"> </el-table-column>
...
export default {
    ...
    methods: {
        ...
        async getData() {
			...
			this.querying = true;
            var jsonData = (await request('/report/customerService/money/list', this.query)).data;
			this.querying = false;
