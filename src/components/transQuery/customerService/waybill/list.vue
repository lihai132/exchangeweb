    ...
    <div class="BaseTable" @click="onMouseDown">
        <div class="container">
                ...
                show-summary>
                    ...
                    <el-table-column :show-overflow-tooltip="true"  prop="fOrderCode"  label="关联订单号" width="150" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fWaybillCode"  label="运单编号" width="150" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fWaybillStatus" :formatter="formatfWaybillStatus"  label="运单状态" width="150" align="center"> </el-table-column>
                    ...
                    <el-table-column :show-overflow-tooltip="true"  prop="fInvoiceFlag" :formatter="formatfInvoiceFlag"  label="是否开票" width="120" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fReceiptFlag" :formatter="formatfReceiptFlag"  label="是否回单" width="120" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fFreight"  label="运费（元）" width="150" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fFreightPayed"  label="已付运费（元）" width="150" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fCreateTime"  label="创建时间" width="180" align="center"> </el-table-column>
                    <el-table-column :show-overflow-tooltip="true"  prop="fCompleteTime"  label="关闭时间" width="180" align="center"> </el-table-column>
                </el-table>
...
export default {
    ...
    methods: {
        ...
        async getData() {
			...
			this.querying = true;
            var jsonData = (await request('/report/customerService/waybill/list', this.query)).data;
			this.querying = false;
            if(jsonData != null){
