    ...
    <div class="BaseTable" @click="onMouseDown">
        <div class="container">
            ...
            >
                ...
                <el-table-column :show-overflow-tooltip="true" prop="fDealerCode" :formatter="codeNameFormat" label="运营中心编号/简称" width="200" align="center"></el-table-column>
				<el-table-column :show-overflow-tooltip="true" prop="reciverInfo" :formatter="reciverNameFormat" label="收款人账号/简称" width="180" align="center"></el-table-column>
				<el-table-column :show-overflow-tooltip="true" prop="reciverInfo" :formatter="reciverTypeFormat" label="收款人类型" width="100" align="center"></el-table-column>
...
export default {
    ...
    methods: {
       ...
       async getData() {
		   ...
		   let list = await request('/fund/payment/center/detailList', this.query);
		   this.querying = false;
		   this.selectedRow='';
