    ...
    <div class="BaseTable" @click="onMouseDown">
        <div class="container">
            ...
            >
                ...
                <el-table-column :show-overflow-tooltip="true" prop="memberCode" :formatter="codeNameFormat" label="运营商编号/简称" width="200" align="center"></el-table-column>
...
export default {
    ...
    methods: {
       ...
       async getData() {
		   ...
		   let list = await request('/fund/payment/trader/refundList', this.query);
		   this.querying = false;
		   this.selectedRow='';
