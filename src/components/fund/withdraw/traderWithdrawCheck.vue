    ...
    <div class="BaseTable" @click="onMouseDown">
        <div class="container">
            ...
            >
				...
				<el-table-column :show-overflow-tooltip="true" prop="fMobile" :formatter="accountNameFormat" label="交易员账号/简称" width="200" align="center"></el-table-column>
                ...
                <el-table-column :show-overflow-tooltip="true" prop="fNameBa" label="提现银行" width="140" align="center"></el-table-column>
                <el-table-column :show-overflow-tooltip="true" prop="fBankNameRel" label="收款银行" width="130" align="center"></el-table-column>
...
import popup from './popup/traderCheckPop.vue';
...
export default {
    ...
    methods: {
       ...
       async getData() {
		   ...
		   let list = await request('/fund/withdraw/trader/waitCheckList', this.query);
		   this.querying = false;
		   this.selectedRow='';
...
            }
        ...
        getSummaries(param) {
            ...
            columns.forEach((column, index) => {
				...
				if(p=='fAmount'||p=='fCharge'||p=='fFundIo'){
